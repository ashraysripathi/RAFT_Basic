    ...
    while True:
        ...
        if decoded_msg['request'] == 'STORE':
            ...
            if state == LEADER:
                ...
                decoded_msg['term'] = None
                decoded_msg['request'] = "LEADER_INFO"
                decoded_msg['key'] = "LEADER"
        ...
        if decoded_msg['request'] == 'RETRIEVE':
            ...
            if state == LEADER:
                ...
                decoded_msg['term'] = None
                decoded_msg['request'] = "RETRIEVE"
                decoded_msg['key'] = "COMMITED_LOGS"
                decoded_msg['value'] = data
                print(decoded_msg)
